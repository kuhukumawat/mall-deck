...
export default function Luxury() {
    ...
    return (
        <section id="luxury" ref={ref} className="py-20 md:py-32 px-6 bg-[#0a0a0a] text-white relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    >
                        <div className="mb-4 md:mb-6 flex items-center gap-4">
                            ...
                            <span className="text-xs md:text-sm font-medium tracking-widest uppercase text-[#D4AF37]">The Experience</span>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="relative h-[350px] md:h-[500px] lg:h-[700px] rounded-[2rem] overflow-hidden group order-1 lg:order-2"
                    >
                        ...
                        <div className="absolute bottom-6 left-6 z-20 glass px-4 md:px-6 py-3 md:py-4 rounded-2xl border-white/10">
                            <p className="text-white text-sm md:text-base font-medium tracking-wide">Opulence Perfected.</p>
                        </div>
                    </motion.div>
