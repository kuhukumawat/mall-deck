...
const diningCategories = [
    ...
    },
    {
        ...
        span: "md:col-span-1 min-h-[250px]",
        delay: 0.2
    },
    {
...
export default function Dining() {
    return (
        <section className="py-32 px-6 bg-[#fafafa] text-black relative">
                ...
                >
                    <div>
                        <div className="mb-4 flex items-center gap-4">
                            ...
                            <span className="text-sm font-medium tracking-widest uppercase text-[#D4AF37]">Taste & Refinement</span>
                        </div>
...
function DiningCard({ title, desc, image, span, delay }: any) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 p-8 z-10 w-full transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <p className="text-white/70 text-sm md:text-base font-light opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">{desc}</p>
            </div>
        </motion.div>
    );
}